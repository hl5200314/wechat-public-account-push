export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxbb9f56a8d5ca150b",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "a7c75756ee94524598c1bbc1b6ec620d",
  ...
  USERS: [
    {
      ...
      id: "oCrus6Zpo3QyJ7Ayezd3q6nY6NPA",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "	yfpozNoI75T-IxIyXTcaYq-TeILevkYoAMFo6wvjXkQ",
      // 所在省份
      province: "广西",
      // 所在城市
      city: "河池",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2001", "date": "03-14"},
      ...
      customizedDateList: [
        // 在一起的日子
        {"keyword": "love_day", date: "2017-02-08"},
        // 结婚纪念日
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "oCrus6YfzHqtiFU_erICAHfPg36o",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
